...
async def can_enroll(course_id):
...
async def enroll_to_course(course_id, student_name):
    await CourseEnrollment.objects.acreate(course_id=course_id, student_name=student_name)
